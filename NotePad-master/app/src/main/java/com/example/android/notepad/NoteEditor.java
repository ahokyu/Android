...
public class NoteEditor extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (color){
            case "purple":
                mText.setBackgroundColor(getResources().getColor(R.color.book_yellow));
                break;
            case "gray":
                mText.setBackgroundColor(getResources().getColor(R.color.gray));
                break;
            case "red":
    ...
    private void initDialog(){
        ...
        yellowTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(NoteEditor.this,"淡黄色",Toast.LENGTH_LONG).show();
                SharedPreferences sharedPreferences=getSharedPreferences("bg_color",MODE_PRIVATE);
                SharedPreferences.Editor editor=sharedPreferences.edit();
                editor.putString("color","book_yellow");
                editor.commit();
                mText.setBackgroundColor(getResources().getColor(R.color.book_yellow));
                backGroundColor="book_yellow";
            }
        });
        greenTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(NoteEditor.this,"灰色",Toast.LENGTH_LONG).show();
                SharedPreferences sharedPreferences=getSharedPreferences("bg_color",MODE_PRIVATE);
                SharedPreferences.Editor editor=sharedPreferences.edit();
        ...
        blueTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(NoteEditor.this,"红色",Toast.LENGTH_LONG).show();
                SharedPreferences sharedPreferences=getSharedPreferences("bg_color",MODE_PRIVATE);
                SharedPreferences.Editor editor=sharedPreferences.edit();
